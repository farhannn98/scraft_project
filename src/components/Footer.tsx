        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-xs text-stone-400 leading-relaxed font-medium mb-6 pe-4">
              {language === "en"
                ? "Bringing the organic beauty of authentic Jepara wood grain into your modern dining room and kitchen. Crafted with precision and durability, to be enjoyed forever."
                : "Menghadirkan keindahan organik serat kayu asli Jepara ke dalam ruang makan dan dapur modern Anda. Dibuat dengan ketelitian dan daya tahan yang prima, untuk dinikmati selamanya."}
            </p>
